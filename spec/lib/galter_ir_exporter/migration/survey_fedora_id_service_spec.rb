...
describe GalterIrExporter::Migration::Survey::FedoraIdService do
  ...
  describe "#register_model" do
    ...
    context "invalid model" do
      ...
      it "throws an error" do
        expect { service.register_model(model_class) }.to raise_error(GalterIrExporter::Migration::Survey::RegistryError)
